...
//            originUrl = "http://饭太硬.com/tv";
            originUrl = CheckUpdateTool.GH_PROXY + "https://raw.githubusercontent.com/a736240087/tvbox/refs/heads/main/1.json";
            Hawk.put(HawkConfig.API_URL, originUrl);
            ArrayList<String> history = Hawk.get(HawkConfig.API_HISTORY, new ArrayList<String>());
            history.add(originUrl);
            history.add(CheckUpdateTool.GH_PROXY + "https://raw.githubusercontent.com/gaotianliuyun/gao/master/0825.json");
            history.add(CheckUpdateTool.GH_PROXY + "https://raw.githubusercontent.com/a736240087/tvbox/refs/heads/main/2.json");
            Hawk.put(HawkConfig.API_HISTORY, history);
        }
        String liveUrl = Hawk.get(HawkConfig.LIVE_URL, "");
        if (liveUrl.isEmpty()) {
            System.out.println("--zkyml>>设置默认直播源");
            liveUrl = "https://raw.githubusercontent.com/a736240087/tvbox/refs/heads/main/tvlive/tvlive.txt";
//            liveUrl = "https://cdn.jsdelivr.net/gh/Guovin/iptv-api@gd/output/result.txt";
            Hawk.put(HawkConfig.LIVE_URL, liveUrl);
        }
        String epgUrl = Hawk.get(HawkConfig.EPG_URL, "");
        if (epgUrl.isEmpty()) {
            System.out.println("--zkyml>>设置默认EPG");
            epgUrl = "https://m3u.ibert.me/epg/112114_xyz.xml";
